    ...
    async update(_deltaTime) {
        if (this.notWay === 0) {
            ...
            if (initFlightState === 5) {
                ...
                await this.setTargetPax(A32NX_InitFlight.MCDU.simbrief.paxCount);
                A32NX_InitFlight.UPDATE_VIEW();
            }
            ...
            if (initFlightState === 7) {
                ...
                this.setTargetPax(A32NX_InitFlight.MCDU.simbrief.paxCount).then(() => {
                    this.setTargetCargo(A32NX_InitFlight.MCDU.simbrief.bagCount, A32NX_InitFlight.MCDU.simbrief.freight).then(() => {
