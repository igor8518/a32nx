...
const SinglePreset = (props: SinglePresetParams) => {
    ...
    return (
        <div className="flex flex-row justify-between my-1">
            ...
            <div className="flex justify-center items-center mx-4 w-full h-24 text-theme-text bg-theme-accent rounded-md border-2 border-theme-accent">
                <SimpleInput
            ...
            <div
                className={`flex justify-center items-center mx-4 w-full h-24 text-theme-text hover:text-theme-body bg-theme-accent hover:bg-theme-highlight rounded-md border-2 border-theme-accent transition duration-100 items-centerh-24 ${!isPowered && 'opacity-50 pointer-events-none'}`}
                onClick={() => handleLoad()}
            >
                Load Preset
            </div>
            ...
            <div
                className={`flex justify-center items-center mx-4 w-full h-24 text-white bg-green-700 hover:bg-green-500 rounded-md border-2 border-green-700 hover:border-green-800 transition duration-100 ${!isPowered && 'opacity-50 pointer-events-none'}`}
                onClick={() => handleSave()}
            >
                Save Preset
            </div>
