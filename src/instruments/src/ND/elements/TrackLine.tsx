...
export const TrackLine: React.FC<{ x: number, y: number, heading: number, track: number, groundSpeed: Knots, mapParams: MapParameters, symbols: NdSymbol[] }> = memo(({ x, y, heading, track, mapParams, groundSpeed, symbols }) => {
