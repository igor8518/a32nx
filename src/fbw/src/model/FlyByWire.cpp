...
void FlyByWireModelClass::step()
{
  ...
  FlyByWire_ConvertToEuler(rtb_GainTheta, rtb_GainPhi, rtb_Gainqk, rtb_Gain, rtb_Gainpk, &rtb_Y_o, &rtb_Y_c, &rtb_Y_n);
  FlyByWire_ConvertToEuler(rtb_GainTheta, rtb_GainPhi, FlyByWire_P.Gainqk1_Gain * (FlyByWire_P.Gain_Gain_e *
    ...
    FlyByWire_P.Gainpk1_Gain * (FlyByWire_P.Gain_Gain_nm * FlyByWire_U.in.data.p_dot_rad_s2), &rtb_Y_f, &rtb_Y_h5,
    &rtb_Y_dd);
  ...
  FlyByWire_Y.out.sim.data.rk_dot_deg_s2 = rtb_Y_h5;
  ...
  if ((rtb_alpha_floor_inhib == 0) && (FlyByWire_U.in.data.V_mach < 0.6)) {
    ...
    if ((rtb_Limiterxi1 > rtb_Gain1_b + rtb_Y_dd) && (FlyByWire_DWork.Delay_DSTATE > 10.0)) {
  ...
  FlyByWire_GetIASforMach4(FlyByWire_U.in.data.V_mach, FlyByWire_P.Constant6_Value, FlyByWire_U.in.data.V_ias_kn,
    &rtb_Y_h5);
  if (FlyByWire_P.Constant5_Value < rtb_Y_h5) {
  ...
  FlyByWire_Y.out.sim.data.qk_deg_s = rtb_Y_o;
  FlyByWire_Y.out.sim.data.rk_deg_s = rtb_Y_c;
  rtb_BusAssignment_a_sim_data_pk_deg_s = rtb_Y_n;
  ...
  FlyByWire_Y.out.sim.data_computed.protection_ap_disc = (((rtb_on_ground == 0) && (((rtb_ap_special_disc != 0) &&
    ...
    (FlyByWire_DWork.sProtActive_k != 0.0));
  FlyByWire_eta_trim_limit_lofreeze(rtb_Y, FlyByWire_DWork.sProtActive_k, &rtb_Y_dd,
  ...
  FlyByWire_eta_trim_limit_lofreeze(rtb_Y, FlyByWire_DWork.sProtActive, &rtb_Y_dd,
  ...
  FlyByWire_RateLimiter(rtb_Sum1_d5, FlyByWire_P.RateLimiterVariableTs_up_d, FlyByWire_P.RateLimiterVariableTs_lo_c,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_d, &rtb_Y_n,
  ...
  if (FlyByWire_DWork.is_active_c6_FlyByWire == 0U) {
    ...
    if ((rtb_Y_n < 1.0) && (FlyByWire_U.in.data.V_tas_kn > 70.0) && ((FlyByWire_U.in.data.thrust_lever_1_pos >= 35.0) ||
  ...
  } else if ((rtb_Y_n == 1.0) || (FlyByWire_U.in.data.H_radio_ft > 400.0) || ((FlyByWire_U.in.data.V_tas_kn < 70.0) &&
  ...
  FlyByWire_RateLimiter(rtb_nz_limit_up_g, FlyByWire_P.RateLimiterVariableTs2_up_f,
                        ...
                        FlyByWire_P.RateLimiterVariableTs2_InitialCondition_b, &rtb_Y_h5,
  ...
  rtb_LimiteriH = FlyByWire_P.Gain1_Gain_j * rtb_Y_o * (FlyByWire_P.Gain_Gain_dc * FlyByWire_P.Vm_currentms_Value) +
  ...
  if (rtb_Gain1_b > rtb_Y_h5) {
    rtb_Gain1_b = rtb_Y_h5;
  ...
  rtb_Sum1_d5 = (((FlyByWire_P.precontrol_gain_Gain * FlyByWire_DWork.Delay1_DSTATE_o + rtb_Y_dd) +
  ...
  FlyByWire_DWork.icLoad_e = ((rtb_Y_n == 0.0) || (rtb_alpha_floor_inhib != 0) || FlyByWire_DWork.icLoad_e);
  ...
  if (rtb_Y_n > FlyByWire_P.Saturation_UpperSat_g4) {
    rtb_Gain1_b = FlyByWire_P.Saturation_UpperSat_g4;
  } else if (rtb_Y_n < FlyByWire_P.Saturation_LowerSat_l) {
  ...
  FlyByWire_Y.out.pitch.data_computed.in_flight_gain = rtb_Y_n;
  FlyByWire_Y.out.pitch.data_computed.in_rotation_gain = rtb_Y_f;
  FlyByWire_Y.out.pitch.data_computed.nz_limit_up_g = rtb_Y_h5;
  FlyByWire_Y.out.pitch.law_normal.eta_dot_deg_s = rtb_Limiterxi;
  rtb_Y_n = look1_binlxpw(FlyByWire_U.in.data.V_tas_kn, FlyByWire_P.uDLookupTable_bp01Data_f,
    FlyByWire_P.uDLookupTable_tableData_f, 3U);
  rtb_Gain1_o = FlyByWire_P.Gain1_Gain_jh * rtb_BusAssignment_sim_input_delta_zeta_pos;
  if (rtb_Gain1_o > rtb_Y_n) {
    rtb_Gain1_o = rtb_Y_n;
  } else {
    rtb_Y_n *= FlyByWire_P.Gain2_Gain_n;
    if (rtb_Gain1_o < rtb_Y_n) {
      rtb_Gain1_o = rtb_Y_n;
    }
  }
  ...
  FlyByWire_RateLimiter(rtb_LimiteriH, FlyByWire_P.RateLimiterVariableTs_up_k, FlyByWire_P.RateLimiterVariableTs_lo_fs,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_f, &rtb_Y_n,
  ...
  FlyByWire_LagFilter(FlyByWire_U.in.data.engine_2_thrust_lbf - FlyByWire_U.in.data.engine_1_thrust_lbf,
                      FlyByWire_P.LagFilter1_C1_j, FlyByWire_U.in.time.dt, &rtb_Y_f, &FlyByWire_DWork.sf_LagFilter_f);
  if (FlyByWire_U.in.data.alpha_deg > FlyByWire_P.Saturation_UpperSat_l) {
    ...
    rtb_Sum1_d5 = FlyByWire_P.Saturation_LowerSat_cj;
  } else {
    rtb_Sum1_d5 = FlyByWire_U.in.data.alpha_deg;
  }

  FlyByWire_LagFilter(rtb_Sum1_d5, FlyByWire_P.LagFilter2_C1, FlyByWire_U.in.time.dt, &rtb_Y_h5,
  ...
  FlyByWire_LagFilter(FlyByWire_U.in.data.engine_1_thrust_lbf - FlyByWire_U.in.data.engine_2_thrust_lbf,
                      FlyByWire_P.LagFilter3_C1, FlyByWire_U.in.time.dt, &rtb_Y_dd, &FlyByWire_DWork.sf_LagFilter_a);
  ...
  rtb_Y_f = (rtb_Y_h5 * rtb_Y_dd * FlyByWire_P.Gain5_Gain_l + FlyByWire_P.Gain4_Gain_f * rtb_Y_f) / rtb_Limiterxi /
  ...
  FlyByWire_LagFilter(rtb_Gain1_b * rtb_Y_n, FlyByWire_P.LagFilter2_C1_c, FlyByWire_U.in.time.dt, &rtb_Y_dd,
  ...
  rtb_LimiteriH = FlyByWire_P.DiscreteTimeIntegratorVariableTs_Gain_d * rtb_Y_dd * FlyByWire_U.in.time.dt;
  FlyByWire_DWork.icLoad_m = ((rtb_Y_n == 0.0) || (rtb_alpha_floor_inhib != 0) ||
  ...
  if (FlyByWire_DWork.Delay_DSTATE_ho > FlyByWire_P.Saturation_UpperSat_f) {
    rtb_LimiteriH = FlyByWire_P.Saturation_UpperSat_f;
  ...
  FlyByWire_RateLimiter(rtb_LimiteriH, FlyByWire_P.RateLimiterVariableTs_up_m, FlyByWire_P.RateLimiterVariableTs_lo_g,
                        FlyByWire_U.in.time.dt, FlyByWire_P.RateLimiterVariableTs_InitialCondition_j, &rtb_Y_dd,
  ...
  if (FlyByWire_U.in.data.V_tas_kn > FlyByWire_P.Saturation_UpperSat_lo) {
    rtb_Sum1_d5 = FlyByWire_P.Saturation_UpperSat_lo;
  ...
  FlyByWire_LagFilter(rtb_Sum1_d5, FlyByWire_P.LagFilter_C1_c, FlyByWire_U.in.time.dt, &rtb_Y_h5,
                      &FlyByWire_DWork.sf_LagFilter_d);
  if (FlyByWire_U.in.data.autopilot_custom_on > FlyByWire_P.Switch2_Threshold_p) {
    rtb_Sum1_d5 = FlyByWire_U.in.data.autopilot_custom_Beta_c_deg + rtb_Y_f;
  } else {
    rtb_Sum1_d5 = FlyByWire_P.Constant3_Value_p;
  }

  FlyByWire_LagFilter(rtb_Sum1_d5, FlyByWire_P.LagFilter1_C1_f, FlyByWire_U.in.time.dt, &rtb_Y_dd,
  ...
  rtb_Gain1_b = rtb_Y_dd - rtb_Y_h5;
  rtb_Y_h5 = FlyByWire_P.Gain4_Gain_o * rtb_Gain1_b;
  ...
  FlyByWire_RateLimiter(rtb_Y_h5 + FlyByWire_DWork.Delay_DSTATE_gt, FlyByWire_P.RateLimiterVariableTs1_up_p,
  ...
  rtb_Gain1_b = ((rtb_Sum1_c * rtb_Y_dd + rtb_LimiteriH) * rtb_Gain1_b + (FlyByWire_P.Constant_Value_l - rtb_Gain1_b) *
  ...
  rtb_Limiterxi = rtb_Y_n + FlyByWire_U.in.data.autopilot_custom_on;
  ...
  rtb_Y_h5 = (FlyByWire_P.Constant_Value_l1 - rtb_Gain1_b) * rtb_BusAssignment_p_roll_data_computed_delta_xi_deg +
  ...
  FlyByWire_RateLimiter(rtb_Y_h5, FlyByWire_P.RateLimiterxi_up, FlyByWire_P.RateLimiterxi_lo, FlyByWire_U.in.time.dt,
                        FlyByWire_P.RateLimiterxi_InitialCondition, &rtb_Limiterxi, &FlyByWire_DWork.sf_RateLimiter_h);
  FlyByWire_RateLimiter(rtb_Y_dd, FlyByWire_P.RateLimiterzeta_up, FlyByWire_P.RateLimiterzeta_lo, FlyByWire_U.in.time.dt,
  ...
  FlyByWire_Y.out.roll.data_computed.in_flight_gain = rtb_Y_n;
  FlyByWire_Y.out.roll.data_computed.zeta_trim_deg_should_write = (FlyByWire_U.in.data.autopilot_custom_on != 0.0);
  FlyByWire_Y.out.roll.data_computed.beta_target_deg = rtb_Y_f;
  ...
  FlyByWire_Y.out.roll.output.xi_deg = rtb_Y_h5;
  FlyByWire_Y.out.roll.output.zeta_deg = rtb_Y_dd;
