...
void AutopilotLawsModelClass::step()
{
  ...
  rtb_Gain_no = 1.0 / distance_m;
  result_tmp[5] = rtb_Gain_no * a;
  result_tmp[8] = rtb_Gain_no * b_R;
  ...
  rtb_Gain_no = std::cos(rtb_error_d);
  rtb_error_d = std::sin(rtb_error_d);
  R = mod_mvZvttxs(mod_mvZvttxs(mod_mvZvttxs(std::atan2(std::sin(L) * R, rtb_Gain_no * std::sin(Phi2) - rtb_error_d * R *
  ...
  distance_m = std::sin((AutopilotLaws_U.in.data.nav_gs_position.lon - AutopilotLaws_U.in.data.aircraft_position.lon) *
                        0.017453292519943295 / 2.0);
  R = std::cos(Phi2);
  a = rtb_Gain_no * R * distance_m * distance_m + a * a;
  distance_m = std::atan2(std::sqrt(a), std::sqrt(1.0 - a)) * 2.0 * 6.371E+6;
  ...
  rtb_Saturation = std::atan2(std::sin(rtb_Saturation) * R, rtb_Gain_no * std::sin(Phi2) - rtb_error_d * R * std::cos
  ...
  switch (static_cast<int32_T>(rtb_error_d)) {
   ...
   case 3:
    rtb_Gain_no = AutopilotLaws_P.Gain_Gain_c * AutopilotLaws_U.in.data.flight_guidance_xtk_nmi * rtb_Saturation_c /
    ...
    L = b_R - (AutopilotLaws_P.Gain2_Gain * AutopilotLaws_U.in.data.flight_guidance_tae_deg + rtb_Gain_no) * a *
      AutopilotLaws_U.in.data.V_gnd_kn;
    break;
  ...
  rtb_Gain_no = AutopilotLaws_P.Gain_Gain_m3 * b_R;
  if (rtb_Gain_no > AutopilotLaws_P.Saturation_UpperSat_c) {
    ...
    AutopilotLaws_Y.out.output.Nosewheel_c = rtb_Gain_no;
  }
  ...
  rtb_Gain_no = b_R / AutopilotLaws_DWork.DelayInput1_DSTATE;
  if (rtb_Gain_no > 1.0) {
    rtb_Gain_no = 1.0;
  ...
  rtb_error_d = AutopilotLaws_P.Gain_Gain_k * std::asin(rtb_Gain_no);
  ...
  rtb_Saturation_c = AutopilotLaws_P.Gain_Gain_es * std::asin(rtb_Gain_no);
  AutopilotLaws_DWork.DelayInput1_DSTATE = AutopilotLaws_P.fpmtoms_Gain * AutopilotLaws_Y.out.data.H_dot_ft_min;
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_m * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  AutopilotLaws_DWork.DelayInput1_DSTATE = std::atan(AutopilotLaws_DWork.DelayInput1_DSTATE / rtb_Gain_no) *
  ...
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_b * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_pf - AutopilotLaws_P.g_Gain * (AutopilotLaws_P.Gain1_Gain_lp *
    ...
    AutopilotLaws_Y.out.data.H_dot_ft_min / rtb_Gain_no))) * (AutopilotLaws_P.Constant_Value_dy - std::cos(b_R)) + std::
  ...
  Phi2 = b_R + a;
  distance_m = AutopilotLaws_P.Constant3_Value_nq - AutopilotLaws_P.Constant4_Value;
  a = (AutopilotLaws_P.Gain1_Gain_ik * b_R + a) * AutopilotLaws_P.Gain_Gain_aj;
  if (distance_m > AutopilotLaws_P.Switch_Threshold_l) {
  ...
  if (R <= b_R) {
    if (distance_m > AutopilotLaws_P.Switch1_Threshold) {
  ...
  R = (AutopilotLaws_P.Gain_Gain_b0 * Phi2 - AutopilotLaws_DWork.DelayInput1_DSTATE) + b_R;
  AutopilotLaws_DWork.DelayInput1_DSTATE = AutopilotLaws_P.fpmtoms_Gain_a * AutopilotLaws_Y.out.data.H_dot_ft_min;
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_p * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_l * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_pf - AutopilotLaws_P.g_Gain_h * (AutopilotLaws_P.Gain1_Gain_dv *
    ...
    AutopilotLaws_Y.out.data.H_dot_ft_min / rtb_Gain_no))) * (AutopilotLaws_P.Constant_Value_cg - std::cos(b_R)) + std::
  ...
  Phi2 = b_R + a;
  distance_m = AutopilotLaws_P.Constant1_Value_b4 - AutopilotLaws_P.Constant2_Value_c;
  a = (AutopilotLaws_P.Gain1_Gain_mz * b_R + a) * AutopilotLaws_P.Gain_Gain_ie;
  if (distance_m > AutopilotLaws_P.Switch_Threshold_b) {
  ...
  if (L <= b_R) {
    if (distance_m > AutopilotLaws_P.Switch1_Threshold_f) {
  ...
  AutopilotLaws_SpeedProtectionSignalSelection(&AutopilotLaws_Y.out, rtb_Saturation_c, AutopilotLaws_P.VS_Gain *
    ...
    AutopilotLaws_P.Constant_Value_ig, &distance_m, &Phi2);
  AutopilotLaws_DWork.DelayInput1_DSTATE = AutopilotLaws_P.fpmtoms_Gain_i * AutopilotLaws_Y.out.data.H_dot_ft_min;
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_hx * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_d * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  AutopilotLaws_LeadLagFilter(b_R - AutopilotLaws_P.g_Gain_g * (AutopilotLaws_P.Gain1_Gain_be *
    ...
    AutopilotLaws_Y.out.data.H_dot_ft_min / rtb_Gain_no))) * (AutopilotLaws_P.Constant_Value_j - rtb_Saturation_c) + R *
  ...
  a = (AutopilotLaws_P.Gain1_Gain_ov * b_R + a) * AutopilotLaws_P.Gain_Gain_a2;
  ...
  if ((rtb_Saturation > AutopilotLaws_P.CompareToConstant_const_a) && (a < AutopilotLaws_P.CompareToConstant1_const_n) &&
    ...
    if (rtb_Saturation > AutopilotLaws_P.Switch2_Threshold) {
      ...
      R = AutopilotLaws_P.Gain5_Gain_f * a;
    }
    ...
    if (b_R > R) {
      ...
      if (rtb_Saturation > AutopilotLaws_P.Switch1_Threshold_o) {
        a = std::fmax(AutopilotLaws_P.Constant2_Value, AutopilotLaws_P.Gain1_Gain_lto * a);
      } else {
        a *= AutopilotLaws_P.Gain6_Gain_l;
      }
  ...
  L = (AutopilotLaws_P.Gain_Gain_ce * rtb_Saturation_c - AutopilotLaws_DWork.DelayInput1_DSTATE) + b_R;
  b_L = AutopilotLaws_Y.out.input.H_dot_c_fpm - AutopilotLaws_Y.out.data.H_dot_ft_min;
  ...
  rtb_Saturation_c = AutopilotLaws_P.Gain_Gain_ey * std::asin(rtb_Gain_no);
  ...
  R = 9.81 / (AutopilotLaws_Y.out.data.V_tas_kn * 0.51444444444444448);
  rtb_Sum_if = R * rtb_Gain_no * 57.295779513082323;
  AutopilotLaws_DWork.DelayInput1_DSTATE = AutopilotLaws_P.fpmtoms_Gain_o * AutopilotLaws_Y.out.data.H_dot_ft_min;
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_o * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  rtb_lo_k = std::cos(b_R);
  rtb_lo_b = std::sin(b_R);
  ...
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_db * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  AutopilotLaws_LeadLagFilter(b_R - AutopilotLaws_P.g_Gain_m * (AutopilotLaws_P.Gain1_Gain_kdq *
    ...
    AutopilotLaws_Y.out.data.H_dot_ft_min / rtb_Gain_no))) * (AutopilotLaws_P.Constant_Value_od - rtb_lo_k) + rtb_lo_b *
    std::sin(rtb_Add3_gy)))), AutopilotLaws_P.HighPassFilter_C1_g, AutopilotLaws_P.HighPassFilter_C2_l,
  ...
  rtb_lo_k = b_R + a;
  rtb_lo_b = AutopilotLaws_P.Constant3_Value_h1 - AutopilotLaws_P.Constant4_Value_f;
  rtb_Gain_no = (AutopilotLaws_P.Gain1_Gain_ovr * b_R + a) * AutopilotLaws_P.Gain_Gain_jy;
  if (rtb_lo_b > AutopilotLaws_P.Switch_Threshold_o) {
  ...
  if (a <= b_R) {
    if (rtb_lo_b > AutopilotLaws_P.Switch1_Threshold_c) {
  ...
  rtb_Add3_gy = (AutopilotLaws_P.Gain_Gain_j * rtb_lo_k - AutopilotLaws_DWork.DelayInput1_DSTATE) + b_R;
  AutopilotLaws_DWork.DelayInput1_DSTATE = AutopilotLaws_P.fpmtoms_Gain_p * AutopilotLaws_Y.out.data.H_dot_ft_min;
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_bq * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_l5 * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  AutopilotLaws_LeadLagFilter(b_R - AutopilotLaws_P.g_Gain_gr * (AutopilotLaws_P.Gain1_Gain_hv *
    ...
    AutopilotLaws_Y.out.data.H_dot_ft_min / rtb_Gain_no))) * (AutopilotLaws_P.Constant_Value_ia - rtb_lo_k) + rtb_lo_b *
    std::sin(rtb_Add3_n2)))), AutopilotLaws_P.HighPassFilter_C1_n, AutopilotLaws_P.HighPassFilter_C2_m,
  ...
  rtb_lo_k = b_R + a;
  rtb_lo_b = AutopilotLaws_P.Constant1_Value_d - AutopilotLaws_P.Constant2_Value_k;
  a = (AutopilotLaws_P.Gain1_Gain_ou * b_R + a) * AutopilotLaws_P.Gain_Gain_jg;
  if (rtb_lo_b > AutopilotLaws_P.Switch_Threshold_a) {
    b_R = AutopilotLaws_P.Constant1_Value_mi;
  } else {
    b_R = AutopilotLaws_P.Gain5_Gain_g * a;
  }

  rtb_Gain_no = rtb_Y_pf * AutopilotLaws_P.Gain1_Gain_gy;
  if (rtb_Gain_no <= b_R) {
    if (rtb_lo_b > AutopilotLaws_P.Switch1_Threshold_b) {
  ...
  b_R += AutopilotLaws_P.Gain_Gain_dm * rtb_lo_k - AutopilotLaws_DWork.DelayInput1_DSTATE;
  AutopilotLaws_SpeedProtectionSignalSelection(&AutopilotLaws_Y.out, rtb_Saturation_c, std::fmax(-rtb_Sum_if, std::fmin
    (rtb_Sum_if, AutopilotLaws_P.VS_Gain_h * rtb_Saturation_c)), rtb_Add3_gy, AutopilotLaws_P.Gain_Gain_h4 * rtb_Add3_gy,
    b_R, AutopilotLaws_P.Gain_Gain_eq * b_R, AutopilotLaws_P.Constant_Value_ga, &rtb_lo_b, &rtb_lo_k);
  AutopilotLaws_DWork.DelayInput1_DSTATE = AutopilotLaws_P.fpmtoms_Gain_ps * AutopilotLaws_Y.out.data.H_dot_ft_min;
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_c * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  rtb_Sum_if = R * 0.05 * 57.295779513082323;
  AutopilotLaws_DWork.DelayInput1_DSTATE = AutopilotLaws_P.fpmtoms_Gain_d * AutopilotLaws_Y.out.data.H_dot_ft_min;
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_cv * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_k * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_d - AutopilotLaws_P.g_Gain_l * (AutopilotLaws_P.Gain1_Gain_n4 *
    ...
    AutopilotLaws_Y.out.data.H_dot_ft_min / rtb_Gain_no))) * (AutopilotLaws_P.Constant_Value_l - a) + rtb_Saturation_c *
  ...
  rtb_Saturation_c = b_R + a;
  rtb_Gain_no = AutopilotLaws_P.Constant3_Value_nk - AutopilotLaws_P.Constant4_Value_o;
  a = (AutopilotLaws_P.Gain1_Gain_on * b_R + a) * AutopilotLaws_P.Gain_Gain_hy;
  if (rtb_Gain_no > AutopilotLaws_P.Switch_Threshold_d) {
  ...
  if (rtb_Add3_n2 <= b_R) {
    if (rtb_Gain_no > AutopilotLaws_P.Switch1_Threshold_d) {
  ...
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_hi * AutopilotLaws_Y.out.data.V_gnd_kn;
  if (rtb_Gain_no > AutopilotLaws_P.Saturation_UpperSat_cv) {
    rtb_Gain_no = AutopilotLaws_P.Saturation_UpperSat_cv;
  ...
  AutopilotLaws_LeadLagFilter(rtb_Y_d - AutopilotLaws_P.g_Gain_hq * (AutopilotLaws_P.Gain1_Gain_mx *
    ...
    AutopilotLaws_Y.out.data.H_dot_ft_min / rtb_Saturation_c))) * (AutopilotLaws_P.Constant_Value_f - a) + rtb_Gain_no *
  ...
  rtb_Gain_fo = (AutopilotLaws_P.Gain1_Gain_nj * b_R + a) * AutopilotLaws_P.Gain_Gain_aq;
  if (rtb_Gain_no > AutopilotLaws_P.Switch_Threshold_g) {
    b_R = AutopilotLaws_P.Constant1_Value_f;
  } else {
    b_R = AutopilotLaws_P.Gain5_Gain_a * rtb_Gain_fo;
  }
  ...
  if (a <= b_R) {
    if (rtb_Gain_no > AutopilotLaws_P.Switch1_Threshold_h) {
      ...
      b_R = AutopilotLaws_P.Gain6_Gain_g * rtb_Gain_fo;
    }
  ...
  AutopilotLaws_SpeedProtectionSignalSelection(&AutopilotLaws_Y.out, rtb_Add3_gy, std::fmax(-rtb_Sum_if, std::fmin
    (rtb_Sum_if, AutopilotLaws_P.Gain_Gain_c3 * rtb_Add3_gy)), rtb_Add3_n2, AutopilotLaws_P.Gain_Gain_fnw * rtb_Add3_n2,
    b_R, AutopilotLaws_P.Gain_Gain_ko * b_R, AutopilotLaws_P.Constant_Value_fo, &rtb_FD_h, &rtb_Gain_fo);
  ...
  AutopilotLaws_Voter1(rtb_Saturation_c + a, AutopilotLaws_P.Gain1_Gain_d4 * ((AutopilotLaws_DWork.DelayInput1_DSTATE +
    ...
    AutopilotLaws_P.Bias1_Bias) - b_R), &rtb_Sum_if);
  ...
  if (AutopilotLaws_Y.out.data.H_radio_ft > AutopilotLaws_P.Saturation_UpperSat_e0a) {
    rtb_Gain_no = AutopilotLaws_P.Saturation_UpperSat_e0a;
  } else if (AutopilotLaws_Y.out.data.H_radio_ft < AutopilotLaws_P.Saturation_LowerSat_m) {
    rtb_Gain_no = AutopilotLaws_P.Saturation_LowerSat_m;
  } else {
    rtb_Gain_no = AutopilotLaws_Y.out.data.H_radio_ft;
  }

  AutopilotLaws_LagFilter(rtb_Gain_no, AutopilotLaws_P.LagFilter_C1_p, AutopilotLaws_Y.out.time.dt, &b_R,
  ...
  rtb_Gain_no = (a - b_R) * AutopilotLaws_P.ftmintoms_Gain_j / AutopilotLaws_DWork.DelayInput1_DSTATE;
  if (rtb_Gain_no > 1.0) {
    rtb_Gain_no = 1.0;
  } else if (rtb_Gain_no < -1.0) {
    rtb_Gain_no = -1.0;
  ...
  rtb_Gain_iq = AutopilotLaws_P.Gain_Gain_by * std::asin(rtb_Gain_no);
  ...
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_iv * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  rtb_Gain_no = AutopilotLaws_P.kntoms_Gain_ka * AutopilotLaws_Y.out.data.V_gnd_kn;
  ...
  AutopilotLaws_LeadLagFilter(b_R - AutopilotLaws_P.g_Gain_l0 * (AutopilotLaws_P.Gain1_Gain_et *
    ...
    AutopilotLaws_Y.out.data.H_dot_ft_min / rtb_Gain_no))) * (AutopilotLaws_P.Constant_Value_f3 - rtb_Cos_k) +
    rtb_Cos1_a * std::sin(rtb_Add3_d1)))), AutopilotLaws_P.HighPassFilter_C1_i0, AutopilotLaws_P.HighPassFilter_C2_j,
  ...
  a = (AutopilotLaws_P.Gain1_Gain_h3 * b_R + a) * AutopilotLaws_P.Gain_Gain_ox;
  b_R = (AutopilotLaws_Y.out.data.V_ias_kn - AutopilotLaws_Y.out.input.V_c_kn) * AutopilotLaws_P.Gain1_Gain_fo;
  if ((rtb_Cos_k > AutopilotLaws_P.CompareToConstant_const_h) && (a < AutopilotLaws_P.CompareToConstant1_const_g) &&
    ...
    if (rtb_Cos_k > AutopilotLaws_P.Switch2_Threshold_b) {
      rtb_Cos1_a = AutopilotLaws_P.Constant1_Value_mq;
    } else {
      rtb_Cos1_a = AutopilotLaws_P.Gain5_Gain_k * a;
    }
    ...
    if (b_R > rtb_Cos1_a) {
      ...
      if (rtb_Cos_k > AutopilotLaws_P.Switch1_Threshold_n) {
        a = std::fmax(AutopilotLaws_P.Constant2_Value_i, AutopilotLaws_P.Gain1_Gain_n * a);
      } else {
        a *= AutopilotLaws_P.Gain6_Gain_o;
      }
  ...
  b_R += AutopilotLaws_P.Gain_Gain_p2 * rtb_Gain_no - AutopilotLaws_DWork.DelayInput1_DSTATE;
  ...
  rtb_Gain_no = a / AutopilotLaws_DWork.DelayInput1_DSTATE;
  if (rtb_Gain_no > 1.0) {
    rtb_Gain_no = 1.0;
  } else if (rtb_Gain_no < -1.0) {
    rtb_Gain_no = -1.0;
  ...
  rtb_Gain_no = AutopilotLaws_P.Gain_Gain_o1 * std::asin(rtb_Gain_no);
  AutopilotLaws_Voter1(rtb_Sum_ia, b_R, rtb_Gain_no, &a);
  AutopilotLaws_DWork.DelayInput1_DSTATE = rtb_Saturation;
  rtb_Saturation = (b_L * AutopilotLaws_P.Gain_Gain_pe + AutopilotLaws_DWork.DelayInput1_DSTATE) *
  ...
  switch (static_cast<int32_T>(rtb_GainTheta1)) {
   ...
   case 6:
    distance_m = AutopilotLaws_P.Gain1_Gain_d * rtb_Sum_if;
    break;

   case 7:
    if (AutopilotLaws_Y.out.data.on_ground > AutopilotLaws_P.Switch1_Threshold_j) {
      distance_m = AutopilotLaws_P.Gain2_Gain_h * rtb_Y_d;
    } else {
      distance_m = (AutopilotLaws_P.Gain1_Gain_i * rtb_Y_pf + rtb_Gain5_n) + rtb_Gain_iq;
    }
    break;
  ...
  AutopilotLaws_VSLimiter(AutopilotLaws_P.VS_Gain_n * rtb_error_d, &AutopilotLaws_Y.out,
    &AutopilotLaws_DWork.DelayInput1_DSTATE);
  AutopilotLaws_VSLimiter(AutopilotLaws_P.Gain_Gain_fo * L, &AutopilotLaws_Y.out, &rtb_GainTheta);
  AutopilotLaws_VSLimiter(rtb_Sum_if, &AutopilotLaws_Y.out, &rtb_error_d);
  if (AutopilotLaws_Y.out.data.on_ground <= AutopilotLaws_P.Switch_Threshold_c) {
    rtb_Y_d = (AutopilotLaws_P.Gain3_Gain_l * rtb_Y_pf + rtb_Gain5_n) + AutopilotLaws_P.VS_Gain_e * rtb_Gain_iq;
  }

  AutopilotLaws_VSLimiter(rtb_Y_d, &AutopilotLaws_Y.out, &distance_m);
  AutopilotLaws_Voter1(rtb_Sum_ia, AutopilotLaws_P.Gain_Gain_jx * b_R, AutopilotLaws_P.VS_Gain_nx * rtb_Gain_no, &L);
  AutopilotLaws_VSLimiter(L, &AutopilotLaws_Y.out, &b_R);
  ...
  switch (static_cast<int32_T>(rtb_GainTheta1)) {
   ...
   case 4:
    AutopilotLaws_DWork.DelayInput1_DSTATE = rtb_lo_k;
    break;

   case 5:
    AutopilotLaws_DWork.DelayInput1_DSTATE = rtb_Gain_fo;
    break;
   ...
   default:
    AutopilotLaws_DWork.DelayInput1_DSTATE = std::fmax(-rtb_Sum_if, std::fmin(rtb_Sum_if, rtb_Saturation));
    break;
  }
  ...
  rtb_GainTheta = R * 0.3 * 57.295779513082323;
