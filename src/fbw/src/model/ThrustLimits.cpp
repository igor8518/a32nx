...
void ThrustLimitsModelClass::step()
{
  ...
  ThrustLimits_RateLimiterwithThreshold((look1_binlxpw(static_cast<real_T>(ThrustLimits_U.in.is_anti_ice_engine_1_active
    ...
    ThrustLimits_P.RateLimiterThresholdVariableTs_Threshold_e, &rtb_Y_p,
  ...
  rtb_ISA_degC = look2_binlxpw(look2_binlxpw(ThrustLimits_U.in.H_ft, std::fmax(std::fmax(std::fmin
    ...
    ThrustLimits_P.Left_bp02Data, ThrustLimits_P.Left_tableData, ThrustLimits_P.Left_maxIndex, 2U) + rtb_Y_p;
  rtb_Y_p = look2_binlcpw(ThrustLimits_U.in.TAT_degC, ThrustLimits_U.in.H_ft, ThrustLimits_P.OATCornerPoint_bp01Data,
  ...
  ThrustLimits_RateLimiterwithThreshold((look2_binlxpw(static_cast<real_T>(ThrustLimits_U.in.is_anti_ice_engine_1_active
    || ThrustLimits_U.in.is_anti_ice_engine_2_active), rtb_Y_p, ThrustLimits_P.AntiIceEngine_bp01Data_i,
    ...
    (ThrustLimits_U.in.is_anti_ice_wing_active), rtb_Y_p, ThrustLimits_P.AntiIceWing_bp01Data_o,
    ...
    ThrustLimits_U.in.is_air_conditioning_2_active), rtb_Y_p, ThrustLimits_P.AirConditioning_bp01Data_e,
    ...
    ThrustLimits_P.RateLimiterThresholdVariableTs_Threshold_o, &rtb_Y_c, &ThrustLimits_DWork.sf_RateLimiterwithThreshold);
  if (ThrustLimits_U.in.use_external_CLB_limit) {
    rtb_Y_c = ThrustLimits_U.in.thrust_limit_CLB_percent;
  } else {
    rtb_Y_c += look2_binlxpw(ThrustLimits_U.in.TAT_degC, ThrustLimits_U.in.H_ft, ThrustLimits_P.MaximumClimb_bp01Data,
  ...
  if (ThrustLimits_DWork.isFlexActive && (ThrustLimits_DWork.prevThrustLimitType == 3.0) &&
    ...
    ThrustLimits_DWork.transitionFactor = (rtb_Y_c - rtb_ISA_degC) / 30.0;
  ...
  if (ThrustLimits_DWork.isTransitionActive) {
    rtb_Y_p = std::fmax(0.0, (ThrustLimits_U.in.simulation_time_s - ThrustLimits_DWork.transitionStartTime) - 10.0);
    if ((rtb_Y_p > 0.0) && (rtb_Y_c > rtb_ISA_degC)) {
      deltaThrust = std::fmin(rtb_Y_c - rtb_ISA_degC, rtb_Y_p * ThrustLimits_DWork.transitionFactor);
    } else {
      deltaThrust = 0.0;
    }

    if (rtb_ISA_degC + deltaThrust >= rtb_Y_c) {
  ...
  rtb_Sum_cy = look2_binlxpw(rtb_Switch2, rtb_Switch1, ThrustLimits_P.AirConditioning_bp01Data_p,
  ...
  ThrustLimits_RateLimiterwithThreshold((look2_binlxpw(static_cast<real_T>(ThrustLimits_U.in.is_anti_ice_engine_1_active
    ...
    2U)) + rtb_Sum_cy, ThrustLimits_P.RateLimiterThresholdVariableTs_up_i,
    ...
    ThrustLimits_P.RateLimiterThresholdVariableTs_Threshold_c, &rtb_Sum_cy,
  ...
  if (ThrustLimits_U.in.H_ft <= ThrustLimits_P.CompareToConstant_const) {
    rtb_Y_p = look2_binlxpw(static_cast<real_T>(ThrustLimits_U.in.is_anti_ice_engine_1_active ||
  ...
  ThrustLimits_RateLimiterwithThreshold((rtb_Y_p + rtb_Switch1) + rtb_Switch2,
    ...
    ThrustLimits_P.RateLimiterThresholdVariableTs_Threshold_g, &rtb_Y_p,
    &ThrustLimits_DWork.sf_RateLimiterwithThreshold_p);
  if (ThrustLimits_DWork.isFlexActive) {
    ThrustLimits_Y.out.thrust_limit_CLB_percent = std::fmin(rtb_Y_c, rtb_ISA_degC) + deltaThrust;
  } else {
    ThrustLimits_Y.out.thrust_limit_CLB_percent = rtb_Y_c;
  }

  ThrustLimits_Y.out.thrust_limit_FLEX_percent = rtb_ISA_degC;
  ThrustLimits_Y.out.thrust_limit_MCT_percent = look2_binlxpw(ThrustLimits_U.in.TAT_degC, ThrustLimits_U.in.H_ft,
    ThrustLimits_P.MaximumContinuous_bp01Data, ThrustLimits_P.MaximumContinuous_bp02Data,
    ThrustLimits_P.MaximumContinuous_tableData, ThrustLimits_P.MaximumContinuous_maxIndex, 26U) + rtb_Sum_cy;
  ThrustLimits_Y.out.thrust_limit_TOGA_percent = look2_binlxpw(ThrustLimits_U.in.TAT_degC, ThrustLimits_U.in.H_ft,
    ThrustLimits_P.MaximumTakeOff_bp01Data, ThrustLimits_P.MaximumTakeOff_bp02Data,
    ThrustLimits_P.MaximumTakeOff_tableData, ThrustLimits_P.MaximumTakeOff_maxIndex, 36U) + rtb_Y_p;
}
